...
public class SmbFile2 extends SmbFile {
	...
	protected static Logger LOG = LoggerFactory.getLogger(SmbFile2.class);
	...
	public SmbFile2 get(String name) throws MalformedURLException, UnknownHostException {
		return new SmbFile2(this, name);
	}
	
	public void copy(SmbFile2 dest,SmbFile2Config config){
	...
	public void copy(SmbFile2 src,SmbFile2 dest){
		// 启用或禁用用户交互（例如弹出一个验证对话框）的上下文中对此 URL 进行检查
