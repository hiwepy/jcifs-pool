...
public class Smb2FileFilters {
     ...
     */
    public static final Smb2FileFilter ALL = new AbstractFileFilter() {
     ...
     */
    public static final Smb2FileFilter NON_NULL = new AbstractFileFilter() {
     ...
     */
    public static final Smb2FileFilter DIRECTORIES = new AbstractFileFilter() {
    ...
    /**
     * <p>
     * Applies an {@link Smb2FileFilter} to the provided {@link File}
     ...
     *
     */
    public static SmbFile[] filter(final Smb2FileFilter filter, final SmbFile... files) throws SmbException {
        if (filter == null) {
     ...
     *
     */
    public static SmbFile[] filter(final Smb2FileFilter filter, final Iterable<SmbFile> files) throws SmbException {
     ...
     *         or <code>files</code> contains a {@code null} value.
     */
    public static List<SmbFile> filterList(final Smb2FileFilter filter, final Iterable<SmbFile> files) throws SmbException {
     ...
     *         or <code>files</code> contains a {@code null} value.
     */
    public static List<SmbFile> filterList(final Smb2FileFilter filter, final SmbFile... files) throws SmbException {
     ...
     *
     */
    public static Set<SmbFile> filterSet(final Smb2FileFilter filter, final SmbFile... files) throws SmbException {
        final SmbFile[] acceptedFiles = filter(filter, files);
     ...
     */
    public static Set<SmbFile> filterSet(final Smb2FileFilter filter, final Iterable<SmbFile> files) throws SmbException {
     ...
     *         or <code>files</code> contains a {@code null} value.
     */
    private static <T extends Collection<SmbFile>> T filter(final Smb2FileFilter filter,
     ...
     */
    public static Smb2FileFilter prefixFileFilter(final String prefix) {
     ...
     */
    public static Smb2FileFilter prefixFileFilter(final String prefix, final IOCase caseSensitivity) {
     ...
     */
    public static Smb2FileFilter suffixFileFilter(final String suffix) {
     ...
     */
    public static Smb2FileFilter suffixFileFilter(final String suffix, final IOCase caseSensitivity) {
     ...
     * @see NameFileFilter
     */
    public static Smb2FileFilter nameFileFilter(final String name) {
     ...
     */
    public static Smb2FileFilter nameFileFilter(final String name, final IOCase caseSensitivity) {
     ...
     */
    public static Smb2FileFilter directoryFileFilter() {
        return Smb2FileFilters.DIRECTORIES;
    }
     ...
     */
    public static Smb2FileFilter fileFileFilter() {
     ...
     */
    public static Smb2FileFilter and(final Smb2FileFilter... filters) {
     ...
     */
    public static Smb2FileFilter or(final Smb2FileFilter... filters) {
     ...
     */
    public static List<Smb2FileFilter> toList(final Smb2FileFilter... filters) {
        if (filters == null) {
            throw new IllegalArgumentException("The filters must not be null");
        }
        final List<Smb2FileFilter> list = new ArrayList<Smb2FileFilter>(filters.length);
     ...
     * @see NotFileFilter
     */
    public static Smb2FileFilter notFileFilter(final Smb2FileFilter filter) {
     ...
     */
    public static Smb2FileFilter trueFileFilter() {
     ...
     */
    public static Smb2FileFilter falseFileFilter() {
     ...
     */
    public static Smb2FileFilter asFileFilter(final Smb2FileFilter filter) {
     ...
     * @see AgeFileFilter
     */
    public static Smb2FileFilter ageFileFilter(final long cutoff) {
     ...
     * @see AgeFileFilter
     */
    public static Smb2FileFilter ageFileFilter(final long cutoff, final boolean acceptOlder) {
     ...
     * @see AgeFileFilter
     */
    public static Smb2FileFilter ageFileFilter(final Date cutoffDate) {
     ...
     * @see AgeFileFilter
     */
    public static Smb2FileFilter ageFileFilter(final Date cutoffDate, final boolean acceptOlder) {
     ...
     * @see AgeFileFilter
     */
    public static Smb2FileFilter ageFileFilter(final File cutoffReference) {
     ...
     * @see AgeFileFilter
     */
    public static Smb2FileFilter ageFileFilter(final File cutoffReference, final boolean acceptOlder) {
     ...
     * @see SizeFileFilter
     */
    public static Smb2FileFilter sizeFileFilter(final long threshold) {
     ...
     * @see SizeFileFilter
     */
    public static Smb2FileFilter sizeFileFilter(final long threshold, final boolean acceptLarger) {
     ...
     * @see SizeFileFilter
     */
    public static Smb2FileFilter sizeRangeFileFilter(final long minSizeInclusive, final long maxSizeInclusive ) {
        final Smb2FileFilter minimumFilter = new SizeFileFilter(minSizeInclusive, true);
        final Smb2FileFilter maximumFilter = new SizeFileFilter(maxSizeInclusive + 1L, false);
     ...
     */
    public static Smb2FileFilter magicNumberFileFilter(final String magicNumber) {
     ...
     */
    public static Smb2FileFilter magicNumberFileFilter(final String magicNumber, final long offset) {
     ...
     */
    public static Smb2FileFilter magicNumberFileFilter(final byte[] magicNumber) {
        return new MagicNumberFileFilter(magicNumber);
    }
     ...
     * @see MagicNumberFileFilter
     */
    public static Smb2FileFilter magicNumberFileFilter(final byte[] magicNumber, final long offset) {
        return new MagicNumberFileFilter(magicNumber, offset);
    }

    //-----------------------------------------------------------------------
    /* Constructed on demand and then cached */
    private static final Smb2FileFilter cvsFilter = notFileFilter(and(directoryFileFilter(), nameFileFilter("CVS")));

    /* Constructed on demand and then cached */
    private static final Smb2FileFilter svnFilter = notFileFilter( and(directoryFileFilter(), nameFileFilter(".svn")));
     ...
     */
    public static Smb2FileFilter makeCVSAware(final Smb2FileFilter filter) {
        if (filter == null) {
            return cvsFilter;
        } else {
     ...
     * @return the decorated filter, never null
     */
    public static Smb2FileFilter makeSVNAware(final Smb2FileFilter filter) {
        if (filter == null) {
            return svnFilter;
        } else {
     ...
     * @param filter  the filter to decorate, null means an unrestricted filter
     * @return the decorated filter, never null
     * @see Smb2FileFilters#DIRECTORIES
     */
    public static Smb2FileFilter makeDirectoryOnly(final Smb2FileFilter filter) {
        if (filter == null) {
            return Smb2FileFilters.DIRECTORIES;
        }
        return new AndFileFilter(Smb2FileFilters.DIRECTORIES, filter);
    }
     ...
     * @see FileFileFilter#FILE
     */
    public static Smb2FileFilter makeFileOnly(final Smb2FileFilter filter) {
        if (filter == null) {
            return FileFileFilter.FILE;
        }
